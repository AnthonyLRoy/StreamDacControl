...
namespace led
{
    ...
    void LED::init(ledc_timer_config_t timerConfig, ledc_channel_config_t channelConfig)
    {
    ...
    esp_err_t LED::setDuty(ledc_mode_t speed_mode, ledc_channel_t channel, uint32_t duty)
    {
      return  ledc_set_duty(speed_mode,channel,duty);
    }

    esp_err_t LED::updateDuty(ledc_mode_t speed_mode, ledc_channel_t channel)
    {
